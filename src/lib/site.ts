...
export const projectPages: Record<string, ProjectPage> = {
  ...
  "choco-cake-recipe": {
    ...
    description: [
      "Choco Cake Recipe is a print design project centered on hierarchy, typography, and grid layout. The brief was to take a single chocolate cake recipe and turn it into three text only layouts using a 12 column grid, two colors, and one inch margins on every side. Each version kept the same content but explored different color palettes and type pairings to see how mood and tone shift through small typographic choices.",
      "The three variations were Black and White with Vidaloka and Roboto, Light Brown and Black with Monarcha and Montserrat, and Dark Brown and Black with Ohno Blazeface and Montserrat. Careful kerning and no hyphenations were used across all of them, and paragraph and character styles kept ingredients, instructions, and headings readable and consistent. The strongest direction was then carried into a final 17 by 11 inch spread that paired the recipe with chocolate cake imagery, balancing typographic detail with a more editorial, photo driven layout.",
    ],
    skills: [
      "Typography",
      "Layout & Hierarchy",
